...
```sh
pip install openpls-engine==1.8.0
```
...
- **Validation paper (SSRN)** — Jacob, Johannes (2026). *OpenPLS Engine: An Open-Source Implementation of Partial Least Squares Structural Equation Modeling Validated Against SmartPLS 4 Across 14 Reference Cases.* SSRN preprint. [doi:10.2139/ssrn.6869001](https://doi.org/10.2139/ssrn.6869001).
